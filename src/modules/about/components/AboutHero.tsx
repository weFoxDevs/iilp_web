...
export default function AboutHero({ data }: AboutHeroProps) {
  ...
  return (
    <section className="relative w-full min-h-[480px] sm:min-h-[580px] lg:min-h-[680px] flex flex-col items-center justify-center pt-[130px] sm:pt-[170px] lg:pt-[220px] pb-[90px] sm:pb-[130px] lg:pb-[180px] px-4 sm:px-6 md:px-8 overflow-hidden">

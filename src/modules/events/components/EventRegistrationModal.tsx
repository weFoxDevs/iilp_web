        ...
        {!isSubmitted ? (
          <>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5 pt-2">
              ...
              <button
                type="submit"
                className="w-full mt-3 bg-[#00bfff] hover:bg-sky-400 text-white font-sans font-semibold text-[16px] py-3.5 px-6 rounded-full shadow-md shadow-sky-200 transition-all cursor-pointer"
              >
                Register
              </button>
            </form>
          ...
          <div className="flex flex-col items-center text-center py-8 px-4 gap-6 animate-in zoom-in-95 duration-200">
            ...
            <div className="flex flex-col gap-3 max-w-[500px]">
              ...
              <p className="font-sans text-base text-gray-600 leading-relaxed">
                ...
                . A confirmation email with event access links and preparation

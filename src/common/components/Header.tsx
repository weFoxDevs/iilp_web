...
export function Header() {
  return (
    <header className="absolute top-0 left-0 z-50 w-full bg-transparent">
      {/* Top Contact Bar */}
      <div className="bg-[#000080] text-white text-xs py-2 hidden md:block">
      ...
      <div className="container mx-auto px-4 md:px-6 pt-4 pb-2">
        <div className="bg-white rounded-[16px] shadow-[0px_37px_81px_0px_rgba(0,0,0,0.06)] flex h-[65px] items-center justify-between px-[30px] py-[9px]">
          ...
          <div className="hidden lg:flex items-center gap-10">
            {/* Links */}
            <nav className="flex items-center gap-4 text-[16px] font-normal text-[#0A0D12]">
              <Link href="/about" className="hover:text-[#00BFFF] transition-colors">About IILP</Link>
              <Link href="/governance" className="hover:text-[#00BFFF] transition-colors">Governance</Link>
              <Link href="/academics" className="hover:text-[#00BFFF] transition-colors">Academics</Link>
              <Link href="/fellowships" className="hover:text-[#00BFFF] transition-colors">Fellowships</Link>
            ...
            <div className="flex items-center gap-2">
              <Link href="/donate" className="text-[14px] font-semibold text-[#101828] hover:text-[#00BFFF] px-4 py-2.5 transition-colors rounded-full">
                Donate
              </Link>
              <Link href="/contact" className="text-[14px] font-semibold text-[#4A5565] bg-[#F9FAFB] border border-[#E5E7EB] hover:bg-gray-100 px-4 py-2.5 rounded-full transition-colors shadow-sm">
                Contact
              </Link>
              <Link href="/apply" className="inline-flex items-center justify-center rounded-full bg-[#00BFFF] px-4 py-2.5 text-[14px] font-semibold text-white shadow-sm hover:bg-[#00a3d9] transition-colors">
                Apply Now
              </Link>
            </div>
          </div>
